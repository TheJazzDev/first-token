...
deploy-core-testnet:
	forge script script/DeployFirstToken.s.sol:DepployFirstToken --rpc-url $(CORE_TESTNET_RPC_URL) --account default --broadcast
...
deploy-bnb-testnet:
	forge script script/DeployFirstToken.s.sol:DepployFirstToken --rpc-url $(BNB_TESTNET_RPC_URL) --account $(ACCOUNT) --api-key $(CORESCAN_API_KEY) --broadcast
